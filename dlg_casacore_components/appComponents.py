"""
dlg_casacore_components appComponent module.

This is the module of dlg_casacore_components containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/dlg_casacore_components.MyApp/String/readonly/
