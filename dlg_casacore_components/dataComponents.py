"""
dlg_casacore_components component module.

This is the module of dlg_casacore_components containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/dlg_casacore_components.MyData/String/readonly/
