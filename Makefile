...
install:          ## Install the project in dev mode.
	...
	$(ENV_PREFIX)pip install -e .[test] --extra-index-url=https://artefact.skao.int/repository/pypi-all/simple
...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=dlg_casacore_components -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "v$${TAG}" > dlg_casacore_components/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add dlg_casacore_components/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "dlg_casacore_components = 'dlg_casacore_components.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run dlg_casacore_components'"
