...
RUN apt update && apt install -y python3-pip casacore-dev git
RUN python3 -m pip install -U pip
RUN apt install -y python3-numpy

# cache packages
RUN pip3 install git+https://github.com/ICRAR/daliuge.git#subdirectory=daliuge-common
RUN pip3 install git+https://github.com/ICRAR/daliuge.git#subdirectory=daliuge-engine
RUN pip3 install pyarrow python-casacore
