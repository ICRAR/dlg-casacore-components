...
original_name="dlg_casacore_components"
original_urlname="dlg-casacore-components"
original_description="Awesome dlg_casacore_components created by ICRAR"
...
mv dlg_casacore_components $name
